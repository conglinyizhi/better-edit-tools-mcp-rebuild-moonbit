...
> A high-performance MCP（Model Context Protocol）file editing toolkit in MoonBit — atomic writes, function-scope detection, snapshot rollback, and fault-tolerant JSON parsing.
>
